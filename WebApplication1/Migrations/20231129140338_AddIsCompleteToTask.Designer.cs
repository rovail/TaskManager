...
namespace TaskManagerApi.Migrations
{
    ...
    [Migration("20231129140338_AddIsCompleteToTask")]
    partial class AddIsCompleteToTask
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManagerApi.Models.Desk", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskManagerApi.Models.ProjectAdmin", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TaskManagerApi.Models.Desk", b =>
                {
                    b.HasOne("TaskManagerApi.Models.User", "Admin")
                        .WithMany("Desks")
            ...
            modelBuilder.Entity("TaskManagerApi.Models.Project", b =>
                {
                    b.HasOne("TaskManagerApi.Models.ProjectAdmin", "Admin")
                        .WithMany("Projects")
                        .HasForeignKey("AdminId");
            ...
            modelBuilder.Entity("TaskManagerApi.Models.Task", b =>
                {
                    ...
                    b.HasOne("TaskManagerApi.Models.Desk", "Desk")
                        .WithMany("Tasks")
